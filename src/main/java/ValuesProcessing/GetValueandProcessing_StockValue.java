...
public class GetValueandProcessing_StockValue 
{
	...
	public GetValueandProcessing_StockValue(String startDate) throws Exception
	{
		// Today
		Today();
		...
		for (Date date : lDate) 
		{
			...
			file = new File(Units.sourceFolder + Units.StockValue);
			//writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), "utf-8"));
			FileWriter writer = new FileWriter(Units.sourceFolder + Units.StockValue, true); 
